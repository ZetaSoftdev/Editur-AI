      ...
      <div className="flex items-center justify-between w-[22rem] sm:w-[30rem] md:w-[56rem] max-w-[56rem] px-1 py-1 rounded-full bg-white shadow-lg">
        ...
        <Link href={"/"} className="flex items-center gap-2 pl-4">
          <Image 
            ...
            height={40} 
          />
          {/* <h1 className="text-white text-lg font-semibold">{branding.siteName}</h1> */}
        </Link>
      ...
      <button onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)} className="md:hidden text-black text-2xl pr-4">
       ...
       {isMobileMenuOpen && (
        ...
        >
          ...
          <Link
            href={"/sign-up"}
            className="mt-6 bg-gradient-to-r from-yellow to-[#dba00be6] text-black font-bold px-6 py-3 rounded-full shadow-md"
          >
            Try for free
          </Link>
        </motion.div>
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="mt-4 flex items-center justify-between">
              <Link href={"/features"} className="bg-gradient-to-r from-yellow to-[#dba00be6] hover:bg-[#ffb800e6] text-black font-bold px-4 py-2 rounded-full">
                View all features
              </Link>
