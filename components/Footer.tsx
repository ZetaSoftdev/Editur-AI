  ...
  return (
    <section className=" text-white py-16 px-4">
        ...
        <div>
          <Link href="/" className="flex items-center gap-2 mb-4 ">
            <Image 
              ...
              height={30} 
            />
            {/* <span className="text-base font-semibold tracking-widest hover:text-gray-300">{branding.siteName}</span> */}
          </Link>
      ...
      <div className="mt-12 border-t border-gray-700 pt-6 text-gray-400 text-sm flex flex-col md:flex-row justify-between">
        <p>© {new Date().getFullYear()} {branding.siteName}, All rights reserved.</p>
      ...
      <button
        ...
        className="fixed bottom-6 right-6  bg-gradient-to-r from-yellow to-[#dba00be6] text-black  p-4 rounded-full shadow-lg hover:bg-yellow-500 transition-all"
      >
